export default {
	...
	title: "mb-4 pt-5 text-4xl font-extrabold leading-none tracking-tight text-indigo-500 md:text-5xl lg:text-6xl text-center",
	box: {
		container: "bg-indigo-500 p-5 my-5 rounded-md",
		top: "flex flex-row justify-between items-center mb-3",
		text: "text-white pe-3",
		select: "text-black p-2 me-3 rounded-md",
		progress: "w-full"
	},
	button: {
