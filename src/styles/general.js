export default {
  ...
  button:
    "text-white bg-indigo-700 disabled:opacity-75 enabled:hover:bg-indigo-800 enabled:focus:ring-4 enabled:focus:outline-none enabled:focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center enabled:dark:bg-indigo-600 enabled:dark:hover:bg-indigo-700 enabled:dark:focus:ring-indigo-800",
  header: {
    container: "flex justify-between items-center",
    title:
      "mb-4 pt-5 text-4xl font-extrabold leading-none tracking-tight text-blue-400 md:text-5xl lg:text-6xl text-center",
  ...
  modal: {
    ...
    content: {
      ...
      title: "mb-4 text-xl font-medium text-gray-900 dark:text-white",
      form: "space-y-6",
